...
def setrun(claw_pkg='geoclaw'):
    ...
    clawdata.lower[0] = -200      # west longitude
    clawdata.upper[0] = -110      # east longitude
    ...
    clawdata.tfinal = days2seconds(20.0)
    # November storm 
...
def setgeo(rundata):
    ...
    topo_data.topofiles.append([4, topo_dir / "GEBCO" / "GEBCO_2025_wrap.nc"])
    
    ncei_base_path = topo_dir / "alaska"
    # topo_data.topofiles.append([4, ncei_base_path / ".nc"])
    ...
    etc_storm = Storm()
    storm_path = (Path(os.environ['DATA_PATH']) / "storms" / "alaska" / "h01_files" / "NNA.4km.hERA5.1989.003.wrf.h01.2011-11-01_2011-11-19.nc").resolve()
    etc_storm.file_paths.append(storm_path)
    etc_storm.time_offset = np.datetime64("2011-11-01T06:00:00")
